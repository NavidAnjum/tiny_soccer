...
<head>
    ...
    <link href="/assets/backend/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="/assets/backend/vendor/chartist/css/chartist.min.css">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/assets/backend/images/logo-white.png" alt="">
                <img class="logo-compact" src="/assets/backend/images/logo-text-white.png" alt="">
                <img class="brand-title" src="/assets/backend/images/logo-text-white.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="/assets/backend/images/profile/pic1.jpg" width="20" alt=""/>
...
{{--                    Starting Diddikicks Sidebar--}}
                    <li class="nav-label">Diddikicks</li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Diddikicks</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./app-profile.html">Add Diddikicks</a></li>

                        </ul>
                    </li>
                    {{--                    End of Diddikicks Sidebar--}}
